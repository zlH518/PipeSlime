...
class Task:
    ...
    async def init(self):
        ...
        self.start_rollout_ids = await asyncio.gather(*(self.actor_model.async_init(self.args, role="actor", with_ref=self.args.kl_coef != 0 or self.args.use_kl_loss)))
        ...
        await asyncio.gather(*(self.actor_model.async_init_weight_update_connections(self.rollout_generator)))
